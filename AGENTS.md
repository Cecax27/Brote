...
- Commands: `npm start`, `npm run lint`
...
The home screen answers a single question: **"What does my garden need today?"**

It should show simply:
...
The user should be able to open the app and know what to do in under five seconds.

---

## Visual Style

The app conveys: **calm, nature, home.**

Visual inspiration comes from watercolor illustrations, earth tones, and natural greens. It doesn't aim to look like a technical tool — it aims to feel welcoming, like an illustrated gardening notebook.

---

## Design Principles

Before adding any new feature, it must answer yes to:
1. Does it make caring for plants simpler?
2. Does it reduce the user's uncertainty?
3. Does it help the user enjoy their plants more?
4. Is the interface still simple?
5. Can the AI offer a concrete action at the end?

If any answer is "no," the feature probably needs rethinking.
